...
import { Gift, Calendar, MapPin, Share2, Copy, MessageCircle, CheckCircle, Loader2 } from "lucide-react";
    ...
    <main className="container mx-auto px-4 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <Card className="overflow-hidden bg-gradient-to-br from-primary/5 via-background to-accent/5 border-primary/20">
          {/* Header Image */}
          {giftBooking.service?.image_url && (
            <div className="h-48 overflow-hidden">
              <img
                src={giftBooking.service.image_url}
                alt={giftBooking.service.name}
