        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-sanskrit text-saffron">{service?.name}</h1>
              <p className="text-muted-foreground">{service?.temple}</p>
            </div>
          ...
          <div className="flex items-center justify-center mb-8">
            {[1, 2, 3, 4].map((s) => (
              <div key={s} className="flex items-center">
                ...
                {s < 4 && (
                  <div className={`w-16 h-1 ${s < step ? 'bg-green-500' : 'bg-temple-dark'}`} />
                )}
              </div>
            ))}
          </div>
